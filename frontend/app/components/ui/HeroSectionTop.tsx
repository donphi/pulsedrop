  ...
  return (
    <div className="bg-background">
      <div className="relative isolate overflow-hidden bg-hero-gradient">
        <div className="mx-auto max-w-7xl pb-24 pt-10 px-8 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:py-40">
              ...
              <div className="max-w-lg">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <a href="#" className="text-sm font-semibold text-foreground">
                    Learn About the Study <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
            ...
            <div className="shadow-lg md:rounded-3xl">
              <div className="bg-primary [clip-path:inset(0)] md:[clip-path:inset(0_round_theme(borderRadius.3xl))]">
                <div
                  className="absolute -inset-y-px left-1/2 -z-10 ml-10 w-[200%] skew-x-[-30deg] bg-primary-muted opacity-20 ring-1 ring-inset ring-transparentWhite md:ml-20 lg:ml-36"
                  aria-hidden="true"
                />
                    ...
                    <div className="w-screen overflow-hidden rounded-tl-xl bg-card">
                      <div className="flex bg-primary-muted-opacity ring-1 bg-transparent-transparentWhite">
                        <div className="-mb-px flex text-sm font-medium text-mutedText">
                          ...
                          <div className="border-r border-mutedText border-opacity-10 px-4 py-2">Metrix</div>
                        </div>
                      </div>
